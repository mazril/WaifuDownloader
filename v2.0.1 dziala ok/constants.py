...
# Zmieniono nazwę pliku statusu - teraz to PHP będzie głównym plikiem
STATUS_PHP_FILE_PATH = os.path.join(SCRIPT_DIR, 'status.php') # Nowa stała (opcjonalna)
...
VERBOSE_VPN_LOGGING = True # To można by przenieść do config.json
MAX_DRIVER_STARTUP_ATTEMPTS = 3
DRIVER_STARTUP_TIMEOUT = 120
AI_MODEL_TO_USE = "google/flan-t5-large" # To też do config.json by się nadawało
